			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlati1 = u_xlati0 << 2;
					    u_xlat2 = u_xlat14.yyyy * unity_ObjectToWorld[1];
					    u_xlat2 = unity_ObjectToWorld[0] * u_xlat14.xxxx + u_xlat2;
					    u_xlat2 = unity_ObjectToWorld[2] * in_POSITION0.zzzz + u_xlat2;
					    u_xlat3 = u_xlat2 + unity_ObjectToWorld[3];
					    u_xlat4 = u_xlat3.yyyy * unity_StereoMatrixVP[(u_xlati1 + 1) / 4][(u_xlati1 + 1) % 4];
					    u_xlat4 = unity_StereoMatrixVP[u_xlati1 / 4][u_xlati1 % 4] * u_xlat3.xxxx + u_xlat4;
					    u_xlat4 = unity_StereoMatrixVP[(u_xlati1 + 2) / 4][(u_xlati1 + 2) % 4] * u_xlat3.zzzz + u_xlat4;
					    u_xlat3 = unity_StereoMatrixVP[(u_xlati1 + 3) / 4][(u_xlati1 + 3) % 4] * u_xlat3.wwww + u_xlat4;
					    u_xlat8.xy = _ScreenParams.yy * unity_StereoMatrixP[(u_xlati1 + 1) / 4][(u_xlati1 + 1) % 4].xy;
					    u_xlat8.xy = unity_StereoMatrixP[u_xlati1 / 4][u_xlati1 % 4].xy * _ScreenParams.xx + u_xlat8.xy;
					    u_xlat8.xy = abs(u_xlat8.xy) * vec2(_ScaleX, _ScaleY);
					    ...
					    if(u_xlatb1){
					        ...
					        u_xlat6.xyz = u_xlat14.yyy * unity_ObjectToWorld[1].xyz;
					        u_xlat6.xyz = unity_ObjectToWorld[0].xyz * u_xlat14.xxx + u_xlat6.xyz;
					        ...
					        u_xlat6.xyz = (-u_xlat6.xyz) + unity_StereoWorldSpaceCameraPos[u_xlati0].xyz;
					    ...
					    u_xlat7.xyz = unity_ObjectToWorld[3].xyz * in_POSITION0.www + u_xlat2.xyz;
					    u_xlat7.xyz = (-u_xlat7.xyz) + unity_StereoWorldSpaceCameraPos[u_xlati0].xyz;
					    u_xlat1.xyz = u_xlat7.yyy * _EnvMatrix[1].xyz;
					    u_xlat1.xyz = _EnvMatrix[0].xyz * u_xlat7.xxx + u_xlat1.xyz;
					    vs_TEXCOORD3.xyz = _EnvMatrix[2].xyz * u_xlat7.zzz + u_xlat1.xyz;
					    gl_Position = u_xlat3;
					    vs_COLOR0 = in_COLOR0;
