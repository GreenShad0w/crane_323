			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat3 = u_xlat2.yyyy * unity_StereoMatrixVP[1 / 4][1 % 4];
					    u_xlat3 = unity_StereoMatrixVP[0 / 4][0 % 4] * u_xlat2.xxxx + u_xlat3;
					    u_xlat3 = unity_StereoMatrixVP[2 / 4][2 % 4] * u_xlat2.zzzz + u_xlat3;
					    u_xlat2 = unity_StereoMatrixVP[3 / 4][3 % 4] * u_xlat2.wwww + u_xlat3;
					    gl_Position = u_xlat2;
					    u_xlat3 = in_COLOR0 * _FaceColor;
					    u_xlat3.xyz = u_xlat3.www * u_xlat3.xyz;
					    vs_COLOR0 = u_xlat3;
					    ...
					    u_xlat2.xyz = vec3(u_xlat10) * u_xlat2.xyz;
					    u_xlat10 = dot(u_xlat2.xyz, u_xlat1.xyz);
					    u_xlat1.xy = _ScreenParams.yy * unity_StereoMatrixP[1 / 4][1 % 4].xy;
					    u_xlat1.xy = unity_StereoMatrixP[0 / 4][0 % 4].xy * _ScreenParams.xx + u_xlat1.xy;
					    u_xlat1.xy = abs(u_xlat1.xy) * vec2(_ScaleX, _ScaleY);
					    u_xlat1.xy = u_xlat2.ww / u_xlat1.xy;
					    u_xlat15 = dot(u_xlat1.xy, u_xlat1.xy);
					    u_xlat1.xy = vec2(_MaskSoftnessX, _MaskSoftnessY) * vec2(0.25, 0.25) + u_xlat1.xy;
					    ...
					    u_xlat15 = u_xlat15 * u_xlat1.x + (-u_xlat11);
					    u_xlat10 = abs(u_xlat10) * u_xlat15 + u_xlat11;
					    u_xlatb15 = unity_StereoMatrixP[3 / 4][3 % 4].w==0.0;
					    u_xlat10 = (u_xlatb15) ? u_xlat10 : u_xlat6.x;
					    u_xlat15 = _OutlineSoftness * _ScaleRatioA;
					    u_xlat15 = u_xlat15 * u_xlat10 + 1.0;
					    u_xlat1.x = u_xlat10 / u_xlat15;
