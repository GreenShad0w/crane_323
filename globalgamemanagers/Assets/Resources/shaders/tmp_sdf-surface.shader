			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2 = u_xlat1 + unity_ObjectToWorld[3];
					    u_xlat1.xyz = unity_ObjectToWorld[3].xyz * in_POSITION0.www + u_xlat1.xyz;
					    u_xlati15 = int(uint(gl_InstanceID) & 1u);
					    u_xlati16 = u_xlati15 << 2;
					    u_xlat3 = u_xlat2.yyyy * unity_StereoMatrixVP[(u_xlati16 + 1) / 4][(u_xlati16 + 1) % 4];
					    u_xlat3 = unity_StereoMatrixVP[u_xlati16 / 4][u_xlati16 % 4] * u_xlat2.xxxx + u_xlat3;
					    u_xlat3 = unity_StereoMatrixVP[(u_xlati16 + 2) / 4][(u_xlati16 + 2) % 4] * u_xlat2.zzzz + u_xlat3;
					    gl_Position = unity_StereoMatrixVP[(u_xlati16 + 3) / 4][(u_xlati16 + 3) % 4] * u_xlat2.wwww + u_xlat3;
					    ...
					    vs_TEXCOORD1.xy = u_xlat3.xy * _OutlineTex_ST.xy + _OutlineTex_ST.zw;
					    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
					    u_xlat7.x = u_xlat2.y * unity_StereoMatrixVP[(u_xlati16 + 1) / 4][(u_xlati16 + 1) % 4].w;
					    u_xlat2.x = unity_StereoMatrixVP[u_xlati16 / 4][u_xlati16 % 4].w * u_xlat2.x + u_xlat7.x;
					    u_xlat2.x = unity_StereoMatrixVP[(u_xlati16 + 2) / 4][(u_xlati16 + 2) % 4].w * u_xlat2.z + u_xlat2.x;
					    u_xlat2.x = unity_StereoMatrixVP[(u_xlati16 + 3) / 4][(u_xlati16 + 3) % 4].w * u_xlat2.w + u_xlat2.x;
					    u_xlat7.xy = _ScreenParams.yy * unity_StereoMatrixP[(u_xlati16 + 1) / 4][(u_xlati16 + 1) % 4].xy;
					    u_xlat7.xy = unity_StereoMatrixP[u_xlati16 / 4][u_xlati16 % 4].xy * _ScreenParams.xx + u_xlat7.xy;
					    ...
					    u_xlat16 = u_xlat16 * u_xlat2.x + (-u_xlat7.x);
					    u_xlat2.xzw = unity_WorldToObject[1].xyz * unity_StereoWorldSpaceCameraPos[u_xlati15].yyy;
					    u_xlat2.xzw = unity_WorldToObject[0].xyz * unity_StereoWorldSpaceCameraPos[u_xlati15].xxx + u_xlat2.xzw;
					    u_xlat2.xzw = unity_WorldToObject[2].xyz * unity_StereoWorldSpaceCameraPos[u_xlati15].zzz + u_xlat2.xzw;
					    ...
					    u_xlat0.x = inversesqrt(u_xlat0.x);
					    u_xlat3 = u_xlat0.xxxx * u_xlat3.xyzz;
					    u_xlat0.xyz = (-u_xlat1.xyz) + unity_StereoWorldSpaceCameraPos[u_xlati15].xyz;
					    gl_Layer = u_xlati15;
					    u_xlat15 = dot(u_xlat0.xyz, u_xlat0.xyz);
					    u_xlat15 = inversesqrt(u_xlat15);
					    u_xlat2.xzw = vec3(u_xlat15) * u_xlat0.xyz;
					    u_xlat15 = dot(u_xlat3.xyw, u_xlat2.xzw);
					    vs_TEXCOORD5.y = abs(u_xlat15) * u_xlat16 + u_xlat7.x;
					    u_xlatb15 = 0.0>=in_TEXCOORD1.y;
					    u_xlat15 = u_xlatb15 ? 1.0 : float(0.0);
					    u_xlat16 = (-_WeightNormal) + _WeightBold;
					    u_xlat15 = u_xlat15 * u_xlat16 + _WeightNormal;
			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2 = u_xlat1 + unity_ObjectToWorld[3];
					    u_xlati15 = int(uint(gl_InstanceID) & 1u);
					    u_xlati3 = u_xlati15 << 2;
					    u_xlat4 = u_xlat2.yyyy * unity_StereoMatrixVP[(u_xlati3 + 1) / 4][(u_xlati3 + 1) % 4];
					    u_xlat4 = unity_StereoMatrixVP[u_xlati3 / 4][u_xlati3 % 4] * u_xlat2.xxxx + u_xlat4;
					    u_xlat4 = unity_StereoMatrixVP[(u_xlati3 + 2) / 4][(u_xlati3 + 2) % 4] * u_xlat2.zzzz + u_xlat4;
					    gl_Position = unity_StereoMatrixVP[(u_xlati3 + 3) / 4][(u_xlati3 + 3) % 4] * u_xlat2.wwww + u_xlat4;
					    ...
					    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
					    u_xlat7.x = u_xlat2.y * unity_StereoMatrixVP[(u_xlati3 + 1) / 4][(u_xlati3 + 1) % 4].w;
					    u_xlat2.x = unity_StereoMatrixVP[u_xlati3 / 4][u_xlati3 % 4].w * u_xlat2.x + u_xlat7.x;
					    u_xlat2.x = unity_StereoMatrixVP[(u_xlati3 + 2) / 4][(u_xlati3 + 2) % 4].w * u_xlat2.z + u_xlat2.x;
					    u_xlat2.x = unity_StereoMatrixVP[(u_xlati3 + 3) / 4][(u_xlati3 + 3) % 4].w * u_xlat2.w + u_xlat2.x;
					    u_xlat7.xy = _ScreenParams.yy * unity_StereoMatrixP[(u_xlati3 + 1) / 4][(u_xlati3 + 1) % 4].xy;
					    u_xlat7.xy = unity_StereoMatrixP[u_xlati3 / 4][u_xlati3 % 4].xy * _ScreenParams.xx + u_xlat7.xy;
					    u_xlat7.xy = u_xlat7.xy * vec2(_ScaleX, _ScaleY);
					    u_xlat2.xy = u_xlat2.xx / u_xlat7.xy;
					    ...
					    u_xlat3.xyz = unity_WorldToObject[1].xyz * unity_StereoWorldSpaceCameraPos[u_xlati15].yyy;
					    u_xlat3.xyz = unity_WorldToObject[0].xyz * unity_StereoWorldSpaceCameraPos[u_xlati15].xxx + u_xlat3.xyz;
					    u_xlat3.xyz = unity_WorldToObject[2].xyz * unity_StereoWorldSpaceCameraPos[u_xlati15].zzz + u_xlat3.xyz;
					    ...
					    u_xlat1 = unity_ObjectToWorld[3] * in_POSITION0.wwww + u_xlat1;
					    u_xlat4.xyz = (-u_xlat3.xyz) + unity_StereoWorldSpaceCameraPos[u_xlati15].xyz;
					    ...
					    vs_TEXCOORD6.y = abs(u_xlat15) * u_xlat2.x + u_xlat12;
					    u_xlatb15 = 0.0>=in_TEXCOORD1.y;
					    u_xlat15 = u_xlatb15 ? 1.0 : float(0.0);
					    u_xlat2.x = (-_WeightNormal) + _WeightBold;
					    u_xlat15 = u_xlat15 * u_xlat2.x + _WeightNormal;
					    ...
					    vs_COLOR0 = in_COLOR0;
					    u_xlat0.xyz = u_xlat4.yyy * _EnvMatrix[1].xyz;
					    u_xlat0.xyz = _EnvMatrix[0].xyz * u_xlat4.xxx + u_xlat0.xyz;
					    vs_TEXCOORD7.xyz = _EnvMatrix[2].xyz * u_xlat4.zzz + u_xlat0.xyz;
					    u_xlat0.xyz = u_xlat1.yyy * unity_WorldToLight[1].xyz;
					    u_xlat0.xyz = unity_WorldToLight[0].xyz * u_xlat1.xxx + u_xlat0.xyz;
					    u_xlat0.xyz = unity_WorldToLight[2].xyz * u_xlat1.zzz + u_xlat0.xyz;
					    vs_TEXCOORD8.xyz = unity_WorldToLight[3].xyz * u_xlat1.www + u_xlat0.xyz;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat2 = u_xlat1 + unity_ObjectToWorld[3];
					    u_xlat1.xyz = unity_ObjectToWorld[3].xyz * in_POSITION0.www + u_xlat1.xyz;
					    u_xlati12 = int(uint(gl_InstanceID) & 1u);
					    u_xlati13 = u_xlati12 << 2;
					    u_xlat3 = u_xlat2.yyyy * unity_StereoMatrixVP[(u_xlati13 + 1) / 4][(u_xlati13 + 1) % 4];
					    u_xlat3 = unity_StereoMatrixVP[u_xlati13 / 4][u_xlati13 % 4] * u_xlat2.xxxx + u_xlat3;
					    u_xlat3 = unity_StereoMatrixVP[(u_xlati13 + 2) / 4][(u_xlati13 + 2) % 4] * u_xlat2.zzzz + u_xlat3;
					    gl_Position = unity_StereoMatrixVP[(u_xlati13 + 3) / 4][(u_xlati13 + 3) % 4] * u_xlat2.wwww + u_xlat3;
					    u_xlat3.x = in_TEXCOORD1.x * 0.000244140625;
					    u_xlat3.x = floor(u_xlat3.x);
					    u_xlat3.y = (-u_xlat3.x) * 4096.0 + in_TEXCOORD1.x;
					    u_xlat3.xy = u_xlat3.xy * vec2(0.001953125, 0.001953125);
					    ...
					    vs_TEXCOORD1.xy = u_xlat3.xy * _OutlineTex_ST.xy + _OutlineTex_ST.zw;
					    vs_TEXCOORD0.xy = in_TEXCOORD0.xy * _MainTex_ST.xy + _MainTex_ST.zw;
					    u_xlat6.x = u_xlat2.y * unity_StereoMatrixVP[(u_xlati13 + 1) / 4][(u_xlati13 + 1) % 4].w;
					    u_xlat2.x = unity_StereoMatrixVP[u_xlati13 / 4][u_xlati13 % 4].w * u_xlat2.x + u_xlat6.x;
					    u_xlat2.x = unity_StereoMatrixVP[(u_xlati13 + 2) / 4][(u_xlati13 + 2) % 4].w * u_xlat2.z + u_xlat2.x;
					    u_xlat2.x = unity_StereoMatrixVP[(u_xlati13 + 3) / 4][(u_xlati13 + 3) % 4].w * u_xlat2.w + u_xlat2.x;
					    u_xlat6.xy = _ScreenParams.yy * unity_StereoMatrixP[(u_xlati13 + 1) / 4][(u_xlati13 + 1) % 4].xy;
					    u_xlat6.xy = unity_StereoMatrixP[u_xlati13 / 4][u_xlati13 % 4].xy * _ScreenParams.xx + u_xlat6.xy;
					    u_xlat6.xy = u_xlat6.xy * vec2(_ScaleX, _ScaleY);
					    ...
					    u_xlat13 = u_xlat13 * u_xlat2.x + (-u_xlat6.x);
					    u_xlat2.xzw = unity_WorldToObject[1].xyz * unity_StereoWorldSpaceCameraPos[u_xlati12].yyy;
					    u_xlat2.xzw = unity_WorldToObject[0].xyz * unity_StereoWorldSpaceCameraPos[u_xlati12].xxx + u_xlat2.xzw;
					    u_xlat2.xzw = unity_WorldToObject[2].xyz * unity_StereoWorldSpaceCameraPos[u_xlati12].zzz + u_xlat2.xzw;
					    u_xlat2.xzw = u_xlat2.xzw + unity_WorldToObject[3].xyz;
					    u_xlat0.z = in_POSITION0.z;
					    u_xlat0.xyz = (-u_xlat0.xyz) + u_xlat2.xzw;
					    u_xlat0.x = dot(in_NORMAL0.xyz, u_xlat0.xyz);
					    ...
					    u_xlat0.x = inversesqrt(u_xlat0.x);
					    u_xlat0.xyz = u_xlat0.xxx * u_xlat3.xyz;
					    u_xlat2.xzw = (-u_xlat1.xyz) + unity_StereoWorldSpaceCameraPos[u_xlati12].xyz;
					    vs_TEXCOORD5.xyz = u_xlat1.xyz;
					    gl_Layer = u_xlati12;
					    u_xlat12 = dot(u_xlat2.xzw, u_xlat2.xzw);
					    u_xlat12 = inversesqrt(u_xlat12);
					    u_xlat1.xyz = vec3(u_xlat12) * u_xlat2.xzw;
					    u_xlat12 = dot(u_xlat0.yzx, u_xlat1.xyz);
					    vs_TEXCOORD6.y = abs(u_xlat12) * u_xlat13 + u_xlat6.x;
					    u_xlatb12 = 0.0>=in_TEXCOORD1.y;
					    u_xlat12 = u_xlatb12 ? 1.0 : float(0.0);
					    u_xlat1.x = (-_WeightNormal) + _WeightBold;
					    u_xlat12 = u_xlat12 * u_xlat1.x + _WeightNormal;
					    ...
					    vs_TEXCOORD4.y = u_xlat3.z;
					    vs_COLOR0 = in_COLOR0;
					    u_xlat0.xyz = u_xlat2.zzz * _EnvMatrix[1].xyz;
					    u_xlat0.xyz = _EnvMatrix[0].xyz * u_xlat2.xxx + u_xlat0.xyz;
					    vs_TEXCOORD7.xyz = _EnvMatrix[2].xyz * u_xlat2.www + u_xlat0.xyz;
					    vs_SV_InstanceID0 =  uint(gl_InstanceID);
					    return;
					}"
				}
			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1.xyz = (-vs_TEXCOORD5.xyz) + unity_StereoWorldSpaceCameraPos[u_xlati0].xyz;
					    u_xlat0.x = dot(u_xlat1.xyz, u_xlat1.xyz);
					    u_xlat0.x = inversesqrt(u_xlat0.x);
					    u_xlat2.xy = vec2(1.0, 1.0) / vec2(_TextureWidth, _TextureHeight);
					    u_xlat2.z = 0.0;
					    ...
					    u_xlat2.xyz = u_xlat2.xxx * u_xlat4.xyz;
					    u_xlat4.xyz = vec3(u_xlat26) * _LightColor0.xyz;
					    u_xlat1.xyz = u_xlat1.xyz * u_xlat0.xxx + u_xlat8.xyz;
					    u_xlat0.x = dot(u_xlat1.xyz, u_xlat1.xyz);
					    u_xlat0.x = inversesqrt(u_xlat0.x);
					    u_xlat1.xyz = u_xlat0.xxx * u_xlat1.xyz;
			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat0 = unity_StereoMatrixVP[3 / 4][3 % 4] * u_xlat0.wwww + u_xlat1;
					    u_xlat1.x = unity_LightShadowBias.x / u_xlat0.w;
					    u_xlat1.x = min(u_xlat1.x, 0.0);
					    u_xlat1.x = max(u_xlat1.x, -1.0);
					    u_xlat4 = u_xlat0.z + u_xlat1.x;
